    ...
    internal sealed partial class NpcTaskBeginForm : BasePanel
    {
        ...
        internal override void Init()
        {
            ...
            if (taskConfig.Type == TaskTypes.Item)
            {
                ...
                {
                    virtualRegion.AddRegion(new PictureAnimRegion(20 + pos, 100 + pos * 50, 190, 30, 30, 20 + pos, VirtualRegionCellType.Item, taskConfig.Content[i]));
                    pos++;
                }
            }
        ...
        private void virtualRegion_RegionClicked(int info, MouseButtons button)
        {
            if (info == 1)
            {
                ...
                {
                    PeopleBook.Fight(taskConfig.Content[0], "house", taskConfig.Content[1], taskConfig.Level, null, onFightWin);
                }
                else
                {
