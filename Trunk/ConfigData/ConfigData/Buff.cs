namespace ConfigDatas
{
	public class BuffConfig
	{
		...
		public string Icon;
		public BuffConfig(){}
		public BuffConfig(int Id,string Name,string Type,BuffEffectDelegate OnAdd,BuffEffectDelegate OnRemove,BuffEffectDelegate OnRound,int[] Effect,bool EndOnHit,FormatStringDelegate GetDescript,int Immune,string Icon)
		{
			this.Id= Id;
			this.Name= Name;
			this.Type= Type;
