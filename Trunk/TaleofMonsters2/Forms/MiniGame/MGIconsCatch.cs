...
namespace TaleofMonsters.Forms.MiniGame
{
    internal partial class MGIconsCatch : BasePanel
    {
        ...
        internal override void Init()
        {
            ...
            this.bitmapButtonC1.ImageMouseOver = HSIcons.GetIconsByEName("atr0");
            this.bitmapButtonC1.ImagePressed = HSIcons.GetIconsByEName("atr0");
            this.bitmapButtonC2.ImageNormal = HSIcons.GetIconsByEName("atr1");
            this.bitmapButtonC2.ImageMouseOver = HSIcons.GetIconsByEName("atr1");
            this.bitmapButtonC2.ImagePressed = HSIcons.GetIconsByEName("atr1");
            this.bitmapButtonC3.ImageNormal = HSIcons.GetIconsByEName("atr2");
            this.bitmapButtonC3.ImageMouseOver = HSIcons.GetIconsByEName("atr2");
            this.bitmapButtonC3.ImagePressed = HSIcons.GetIconsByEName("atr2");
            this.bitmapButtonC4.ImageNormal = HSIcons.GetIconsByEName("atr3");
            this.bitmapButtonC4.ImageMouseOver = HSIcons.GetIconsByEName("atr3");
            this.bitmapButtonC4.ImagePressed = HSIcons.GetIconsByEName("atr3");
            this.bitmapButtonC5.ImageNormal = HSIcons.GetIconsByEName("atr4");
            this.bitmapButtonC5.ImageMouseOver = HSIcons.GetIconsByEName("atr4");
            this.bitmapButtonC5.ImagePressed = HSIcons.GetIconsByEName("atr4");
            this.bitmapButtonC6.ImageNormal = HSIcons.GetIconsByEName("atr5");
            this.bitmapButtonC6.ImageMouseOver = HSIcons.GetIconsByEName("atr5");
            this.bitmapButtonC6.ImagePressed = HSIcons.GetIconsByEName("atr5");
            this.bitmapButtonC7.ImageNormal = HSIcons.GetIconsByEName("atr6");
            this.bitmapButtonC7.ImageMouseOver = HSIcons.GetIconsByEName("atr6");
            this.bitmapButtonC7.ImagePressed = HSIcons.GetIconsByEName("atr6");
            this.bitmapButtonC8.ImageNormal = HSIcons.GetIconsByEName("atr7");
            this.bitmapButtonC8.ImageMouseOver = HSIcons.GetIconsByEName("atr7");
            this.bitmapButtonC8.ImagePressed = HSIcons.GetIconsByEName("atr7");
            this.bitmapButtonC9.ImageNormal = HSIcons.GetIconsByEName("atr8");
            this.bitmapButtonC9.ImageMouseOver = HSIcons.GetIconsByEName("atr8");
            this.bitmapButtonC9.ImagePressed = HSIcons.GetIconsByEName("atr8");
            #endregion
