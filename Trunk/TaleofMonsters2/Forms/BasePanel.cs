...
namespace TaleofMonsters.Forms
{
    internal class BasePanel : UserControl
    {
        ...
        private bool needBlackForm;
        private long lastMouseMoveTime;
        private List<FlowData> flows;

        public bool IsChangeBgm
        {
            get { return isChangeBGM; }
            set { isChangeBGM = value; }
        }

        public bool NeedBlackForm
        {
            get { return needBlackForm; }
            set { needBlackForm = value; }
        }
        ...
        void BasePanel_Paint(object sender, PaintEventArgs e)
        {
            if (flows.Count>0)
            {
                Font ft = new Font("Î¢ÈíÑÅºÚ", 14, FontStyle.Bold);
